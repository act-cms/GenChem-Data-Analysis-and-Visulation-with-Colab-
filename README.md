...
2. Reaction Kinetics of Organic Reactions
    ...
    * Description: In this lesson, students will use integrated rate laws to analyze kinetics data for organic reactions.

3. Reaction Kinetics of Drug Degradation
    * Directory: `03_Drug-Degradation
    * Description: In this lesson, students will use the Arrhenius Equation to analyze kinetics data for drug degradation. 

4. Titration Curves of Common Acids
    * Directory: `04_Titration-Curves
    * Description: In this lesson, students will analyze titration curves of common weak acids.

5. Impact of Concentrations on Voltaic Cell potentials
    * Directory: `05_Voltaic-Cells
    * Description: In this lesson, students will use the Nernst Equation to analyze the relationship between cell concentrations and cell potentials.
